...
import { logRequests, redirectLogin, redirectRegister, protectRoute, adminOnly, handleLogout } from './middleware.js';
...
app.use(logRequests);
app.use('/login', redirectLogin);
app.use('/register', redirectRegister);
